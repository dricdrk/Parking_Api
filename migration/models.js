...
con.connect(function(err) {
    ...
    con.query("CREATE DATABASE mydb", function (err, result) {
      ...
      var Parkingplacesreserved  = "CREATE TABLE reserved (`id` INT NOT NULL AUTO_INCREMENT , `id_place` DATE NOT NULL , `start_date` DATE NOT NULL , `end_date` INT NOT NULL , `id_user` INT NOT NULL , `amount` FLOAT NOT NULL ,`code` INT NOT NULL , PRIMARY KEY (`id`))";
